...
![image](/assets/images/stm32f4/cubemx_spi_1.jpg){: width="50%" height="50%"}
![image](/assets/images/stm32f4/cubemx_spi_2.jpg){: width="50%" height="50%"}
- 대부분 기본 셋팅이며, Baud Rate는 10 Mbps 이상도 문제없이 된다고 하는 것 같다. 하지만 안정성을 위해 10 Mbps 근처로 설정하였다.
- NSS는 software로 설정해야 한다.

#### ② FatFS
- FatFS 설정을 항목이 상당히 많은데, 빨간 박스 부분의 설정만 바꿔주도록 한다.
![image](/assets/images/stm32f4/cubemx_fatfs.png){: width="50%" height="50%"}
